...
export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, an AI assistant trained on evidence-based fitness principles developed to help you create a strong, aesthetic physique to make you feel and look like your best self! Created by ${OWNER_NAME}.`
